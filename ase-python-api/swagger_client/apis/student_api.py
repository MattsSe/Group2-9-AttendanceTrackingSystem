...
class StudentApi(object):
    ...
    def student_auth_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.student_auth_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.student_auth_post_with_http_info(**kwargs)
        else:
            (data) = self.student_auth_post_with_http_info(**kwargs)
            return data

    def student_auth_post_with_http_info(self, **kwargs):
        """
        logs the student into the system
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.student_auth_post_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method student_auth_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/student/auth', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
